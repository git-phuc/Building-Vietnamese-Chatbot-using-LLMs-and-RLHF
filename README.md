...
|---|---|---|---|---|
| 1 | CPT tiếng Việt (QLoRA r=64) | §6.1 | `<user>/Qwen3-1.7B-vi-cpt` | 🟡 **Notebook A ✅ xong (2026-07-18)** — data tại `Phuc-HugigFace/vi-cpt-corpus-2048`. **Notebook B đang train: 737/3000 step (2026-07-20)** — bản save-20 chạy trọn vẹn session đầu: eval@600 OK (vi 5.94 / en 5.79), checkpoint-737 đã trên `Phuc-HugigFace/Qwen3-1.7B-vi-cpt-ckpt`, 104 s/step. Session sau: tick lại 2 secret, Run All — tự resume từ 737; còn ~6-7 session nữa |
