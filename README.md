...
|---|---|---|---|---|
| 1 | CPT tiếng Việt (QLoRA r=64) | §6.1 | `<user>/Qwen3-1.7B-vi-cpt` | 🟡 **Notebook A ✅ xong (2026-07-18)** — data tại `Phuc-HugigFace/vi-cpt-corpus-2048`. **Notebook B đang train: 1858/3000 step (2026-07-20)** — 3 session liên tiếp thành công (737→1190→1546→1858), retry Hub đã tự phục hồi 1 lần lỗi 503 không mất step nào; checkpoint-1858 trên `Phuc-HugigFace/Qwen3-1.7B-vi-cpt-ckpt`, ~92-112 s/step, train loss ổn định ~3.0. Eval qua 3 mốc (600/1200/1800) chưa cho thấy xu hướng giảm rõ (vi 5.94→6.14→6.14, en 5.79→5.93→5.95) — theo dõi tiếp ở 2400/3000, chưa kết luận vấn đề. Session sau: tick lại 2 secret, Run All — tự resume từ 1858; còn ~3-4 session nữa |
