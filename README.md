...
|---|---|---|---|---|
| 1 | CPT tiếng Việt (QLoRA r=64) | §6.1 | `<user>/Qwen3-1.7B-vi-cpt` | 🟡 **Notebook A ✅ xong (2026-07-18)** — data tại `Phuc-HugigFace/vi-cpt-corpus-2048`. **Notebook B đang train: 400/3000 step (2026-07-19)** — session batch đầu tiên xong, checkpoint-200 + checkpoint-400 đã push lên `Phuc-HugigFace/Qwen3-1.7B-vi-cpt-ckpt`, đo ~95-103 s/step, session sống ~11.5h. Session sau: import bản notebook MỚI (save mỗi 20 step + eval batch 2 ở mốc 620 — chết kiểu gì cũng chỉ mất ≤20 step), tick lại 2 secret, Run All — tự resume từ 400 |
