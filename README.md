...
|---|---|---|---|---|
| 1 | CPT tiếng Việt (QLoRA r=64) | §6.1 | `<user>/Qwen3-1.7B-vi-cpt` | 🟡 **Notebook A ✅ xong (2026-07-18)** — data tại `Phuc-HugigFace/vi-cpt-corpus-2048`. **Notebook B đang train: 1546/3000 step (2026-07-20)** — 2 session liên tiếp thành công (737→1190→1546), retry Hub đã tự phục hồi 1 lần lỗi 503 không mất step nào; checkpoint-1546 trên `Phuc-HugigFace/Qwen3-1.7B-vi-cpt-ckpt`, ~92-104 s/step, loss ổn định ~3.0. Session sau: tick lại 2 secret, Run All — tự resume từ 1546 (mốc eval tiếp theo: 1800); còn ~4 session nữa |
