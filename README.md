...
3. Upload `notebooks/01-cpt/CPT-Step-B-Train-Qwen3-1.7B.ipynb`, bật GPU T4, Run All mỗi session — tự resume, tự dừng trước khi hết giờ; lặp đến khi đạt `max_steps=6000` thì notebook tự push bản merged `<user>/Qwen3-1.7B-vi-cpt`.
