...
|---|---|---|---|---|
| 1 | CPT tiếng Việt (QLoRA r=64) | §6.1 | `<user>/Qwen3-1.7B-vi-cpt` | 🟡 **Notebook A lỗi 403 ở cell push** (2026-07-17): `HF_USER` gõ tay sai namespace → đã sửa cả 3 notebook tự lấy username qua `whoami()` + kiểm tra Write token. **Việc cần làm: chép cell Config mới vào notebook trên Kaggle rồi chạy lại A** |
